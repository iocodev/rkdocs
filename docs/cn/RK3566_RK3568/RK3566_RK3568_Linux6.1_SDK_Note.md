...
## rk3566_rk3568_linux6.1_release_v1.3.0_20251220.xml Note

### System & Base Framework Updates

- Kernel upgraded **6.1.118 → 6.1.141**

- Yocto upgraded **5.0.8 → 5.0.14**

- Debian upgraded to **12.12**

- Buildroot core platform components updated

- Removed **Python2 dependency**

- **RISC-V support enabled**

- Improved automatic cross-toolchain detection mechanism

### Yocto Updates

- Adapted to latest **GStreamer & Weston patches**

- Fixed **dhcpcd abnormal behavior**

- **umtprd supports USB 3.0**, compatible when kernel message queue is disabled

- **adbd supports IPv6-disabled scenario**

- ADB supports **disable TCP network function**

### Debian Improvements

- Fixed Xserver `enc_clone_mask` handling & optimized display switching logic

- Fixed **RK3588 Debian12 V130 HDMI resolution switch failure (low→high)**

- Added support to build **Debian without desktop**

- Support mounting **tmpfs on `/tmp`**

- Support customizable Debian package list

- Support configuring **default username & password**

- Support **serial login authentication**

- Support building **chip-specific Debian firmware images**

### RootFS / Filesystem

- Support **read-only rootfs**

- Enable **rootfs check & recovery under systemd**

- Support **compressed root filesystem**

- Support user partition filesystem build parameter configuration

- Fixed kernel build issue when **recovery is disabled**

- Fixed user partition **read-only mount default issue**

- Fixed **UBI PEB size configuration issue**

- Fixed **async-commit not effective under systemd**

- Fixed **first boot rootfs read-only mount issue**

- Support **jumping to specific config menu directly**

### Kernel & Driver Fixes / Optimization

- Fixed **ADB unstable connection** on macOS / Ubuntu in Linux-6.1 SDK

- Fixed **PCIe power-cycle test issue**

- Improved **exFAT write performance**

- Fixed **Bluetooth file transfer failure**

- Fixed **USB-gadget restart & hot-plug instability**

- Fixed **OTG/HOST switching abnormal**

- Fixed **USB malfunction after PC suspend/resume**

- Fixed **SPI half-level signal issue** on RK806

- Fixed **recovery build affecting normal kernel firmware issue**

### ISP / Multimedia / Video Enhancements

- Fixed **multi-camera AIISP crash during dynamic switching**

- Improved **FPN + AIBNR image quality**

  > Requires **rkaiq ≥ v6.0x32.0** & ISP driver **≥ v3.2.0**

### RTOS Updates

- Added **RPMSG optimization for RK3576 / RK3588**

### Miscellaneous Enhancements

- Support **quick navigation to specific configuration menu**

- Support **rootfs compression**

- Enhanced **ADB network control**

- Debian user configuration usability improvements

- Support building **chip-customized Debian images**
